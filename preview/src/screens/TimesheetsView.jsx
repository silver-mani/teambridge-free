...
const ROWS = [
  ...
  { id: 'maria',   name: 'Maria Cruz',    role: 'Bev Service', reg: 38.0, ot: 0.0,  total: 38.0, status: 'approved', initials: 'MC', color: '#9d174d' },
  { id: 'carlos',  name: 'Carlos Mendez', role: 'Premium',     reg: 36.0, ot: 0.0,  total: 36.0, status: 'approved', initials: 'CM', color: '#5b21b6' },
  { id: 'ravi',    name: 'Ravi Banerjee', role: 'Security',    reg: 34.0, ot: 0.0,  total: 34.0, status: 'approved', initials: 'RB', color: '#92400e' },
  ...
  { id: 'tasha',   name: 'Tasha K.',      role: 'Bev Service', reg: 15.0, ot: 0.0,  total: 15.0, status: 'approved', initials: 'TK', color: '#166534' },
