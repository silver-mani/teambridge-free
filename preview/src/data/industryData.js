...
const EVENTS_RECORDS = {
  ...
  'credential': {
    ...
    activity: [
      ...
      { kind: 'agent', agentId: 'iris',  actor: 'Iris',  verb: 'assigned Saturday Civic Arena · beverage service',         time: '1 hr ago' },
      ...
      { kind: 'agent', agentId: 'iris',  actor: 'Iris',  verb: 'background check cleared — no adverse records',            time: '1 hr 5 min ago' },
      { kind: 'agent', agentId: 'iris',  actor: 'Iris',  verb: 'ran OFAC / sanctions screen — clear',                      time: '1 hr 6 min ago' },
      { kind: 'agent', agentId: 'iris',  actor: 'Iris',  verb: 'verified TABC license with the state registry',            time: '1 hr 8 min ago' },
      { kind: 'agent', agentId: 'iris',  actor: 'Iris',  verb: 'validated driver license with DMV',                        time: '1 hr 9 min ago' },
      { kind: 'agent', agentId: 'iris',  actor: 'Iris',  verb: 'parsed driver license + work authorization',               time: '1 hr 10 min ago' },
      { kind: 'user',  actor: 'Sarah M.', avatar: SARAH.avatar, verb: 'uploaded required documents',                       time: '1 hr 12 min ago' },
      { kind: 'agent', agentId: 'sofia', actor: 'Sofia', verb: 'nudged Sarah to finish document upload',                   time: '2 hrs ago',
        comm: { type: 'sms', contact: 'Sarah M.', phone: '+1 (415) 555-0181',
                messages: [
                  { from: 'agent', text: 'Hi Sarah — 2 docs left to upload (TABC cert + driver license). Link in your app. Takes ~3 min.', time: '2:01 PM' },
                  { from: 'them',  text: 'On it.', time: '2:07 PM' },
                ] } },
      { kind: 'agent', agentId: 'nova',  actor: 'Nova',  verb: 'paired Sarah with Priya S. as her first-shift buddy',      time: '3 hrs ago' },
      { kind: 'user',  actor: 'Priya S.', verb: 'agreed to buddy Sarah for Saturday',                                      time: '3 hrs ago' },
      { kind: 'agent', agentId: 'sofia', actor: 'Sofia', verb: 'enrolled Sarah in direct deposit',                         time: '4 hrs ago' },
      { kind: 'user',  actor: 'Sarah M.', avatar: SARAH.avatar, verb: 'submitted W-4 and I-9',                             time: '4 hrs ago' },
      { kind: 'agent', agentId: 'leo',   actor: 'Leo',   verb: 'confirmed minor-work rules do not apply',                  time: '4 hrs ago' },
      { kind: 'agent', agentId: 'atlas', actor: 'Atlas', verb: 'matched Sarah to 3 open Saturday shifts',                  time: '5 hrs ago' },
      { kind: 'user',  actor: 'Miguel R.', verb: 'approved Sarah\'s Saturday assignment',                                  time: 'Yesterday 5:40 PM' },
      { kind: 'agent', agentId: 'sofia', actor: 'Sofia', verb: 'sent orientation modules + login credentials',             time: 'Yesterday 4:12 PM',
        comm: { type: 'email', contact: 'Sarah M.', to: 'sarah.m@teambridge.events',
                subject: 'Welcome to Teambridge — orientation + first-shift prep',
                body: `Hi Sarah,\n\nWelcome to the team! Please complete the two orientation modules below before Saturday:\n\n1. Workplace Safety (15 min)\n2. Harassment & Respect (12 min)\n\nYour login: sarah.m@teambridge.events\nTemporary password in the app.\n\nYou\'ll report 6:30 PM Saturday to the Civic Arena bev-service area. Priya S. will buddy your first shift.\n\n— Sofia, People Ops` } },
      { kind: 'user',  actor: 'Sarah M.', avatar: SARAH.avatar, verb: 'completed Safety + Harassment modules (100%)',      time: 'Yesterday 3:18 PM' },
      { kind: 'user',  actor: 'Sarah M.', avatar: SARAH.avatar, verb: 'passed TABC practice exam — 92%',                   time: 'Yesterday 2:45 PM' },
      { kind: 'user',  actor: 'Sarah M.', avatar: SARAH.avatar, verb: 'e-signed offer letter',                             time: 'Yesterday 1:30 PM' },
      { kind: 'user',  actor: 'Miguel R.', verb: 'countersigned offer letter',                                             time: 'Yesterday 1:32 PM' },
      { kind: 'agent', agentId: 'sofia', actor: 'Sofia', verb: 'created Sarah\'s profile in payroll + scheduling',         time: 'Yesterday 1:00 PM' },
      { kind: 'user',  actor: 'Miguel R.', verb: 'reviewed Sarah\'s interview notes',                                      time: 'Yesterday 12:45 PM' },
      { kind: 'user',  actor: 'HR', verb: 'added Sarah to the roster',                                                     time: 'Mar 12, 2026' },
      { kind: 'user',  actor: 'Recruiting', verb: 'referred Sarah M. from the open call',                                  time: 'Mar 10, 2026' },
    ],
  },
