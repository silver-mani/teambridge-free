  ...
  'last-min-replacement': {
    ...
    conversations: [
      { id: 'sandra-call', kind: 'voice', contact: 'Sandra Lee',
        ...
        duration: '1:22',
        turns: [
          { speaker: 'them',  speakerName: 'Sandra', voiceId: 'MF3mGyEYCl7XYWbV9V6O',
            text: "Hi, can't make my 7pm usher shift Saturday at Civic Arena — family emergency came up." },
          { speaker: 'agent', speakerName: 'Nova',   voiceId: 'EXAVITQu4vr4xnSDxMaL',
            text: "Got it Sandra, no penalty on your record. I'll find the replacement — you take care of yourself." },
        ],
      },
      { id: 'rachel-call', kind: 'voice', contact: 'Rachel Williams',
        ...
        turns: [
          { speaker: 'agent', speakerName: 'Nova',   voiceId: 'EXAVITQu4vr4xnSDxMaL',
            text: "Hi Rachel, Nova from Teambridge. Sandra just cancelled her 7pm usher shift Saturday. You're the closest qualified usher with strong guest ratings. Can you take it?" },
          { speaker: 'them',  speakerName: 'Rachel', voiceId: '21m00Tcm4TlvDq8ikWAM',
            text: "Yes! I'm available, count me in." },
          { speaker: 'agent', speakerName: 'Nova',   voiceId: 'EXAVITQu4vr4xnSDxMaL',
            text: "Perfect — approval pending. Report 6:30 PM to the east entry. Details are in your app." },
        ],
      },
