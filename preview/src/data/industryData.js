  ...
  rows: [
    ...
    { userId: 'david',   name: 'David Kim',
      ...
      shifts: {
        ...
        sat: { start: '2:00p',  end: '12:00a', role: 'Security',     venue: "Levi's", status: 'upcoming'  },
      } },
    ...
    { userId: 'diane',   name: 'Diane Kim',
      ...
      shifts: {
        ...
        sat: { start: '2:00p',  end: '11:00p', role: 'F&B',          venue: "Levi's", status: 'upcoming'  },
      } },
    ...
    { userId: 'trevor',  name: 'Trevor Booth',
      ...
      shifts: {
        ...
        sat: { start: '5:00p',  end: '12:00a', role: 'Security',     venue: 'Civic',  status: 'upcoming'  },
      } },
    ...
    { userId: 'ravi',    name: 'Ravi Banerjee',
      ...
      shifts: {
        ...
        sat: { start: '3:00p',  end: '12:00a', role: 'Security',     venue: "Levi's", status: 'upcoming'  },
      } },
    ...
    { userId: 'maria-c', name: 'Maria Cruz',
      ...
      shifts: {
        ...
        sat: { start: '3:00p',  end: '11:00p', role: 'Bev Service',  venue: "Levi's", status: 'upcoming'  },
      } },
    ...
    { userId: 'jasmine', name: 'Jasmine Park',
      ...
      shifts: {
        ...
        sat: { start: '4:00p',  end: '10:00p', role: 'Premium Host', venue: "Levi's", status: 'upcoming'  },
      } },
  ],
}
